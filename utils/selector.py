...
class CssSelector:
    ...
    def find_next_selector(link):
        domain_mappings = {
            ...
            "soruncg.com": ["#container > div > div > div.reader-main > div.section-opt.m-bottom-opt > a:nth-child(5)", "title"],
            "novelnext.com": ["#next_chap", "#chapter > div > div > a"],
            "bonnovel.com": ["None", "#manga-reading-nav-head > div > div.entry-header_wrap > div > div.c-breadcrumb > ol > li:nth-child(2) > a"],
